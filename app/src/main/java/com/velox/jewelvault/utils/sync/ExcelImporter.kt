                    ...
                    RestoreMode.MERGE -> {
                        if (existingItem == null) {
                            val item = ItemEntity(
                                ...
                                othCrgDes = getCellValueAsString(cell(row, headerMap, "othCompDes", ItemCols.OTHCRGDES)),
                                othCrg = getCellValueAsDouble(cell(row, headerMap, "othCompCrg", ItemCols.OTHCRG)),
                    ...
                    RestoreMode.MERGE -> {
                        if (existingOrderItem == null) {
                            val orderItem = OrderItemEntity(
                                ...
                                othCrgDes = getCellValueAsString(cell(row, headerMap, "othCompDes", OrderItemCols.OTHCRGDES)),
                                othCrg = getCellValueAsDouble(cell(row, headerMap, "othCompCrg", OrderItemCols.OTHCRG)),
                                ...
                                tax = getCellValueAsDouble(cell(row, headerMap, "taxPercentage", OrderItemCols.TAX)),
